...
public class AppTest 
{
    ...
    public void testPersonnel() {
    	...
    	Personnel p1 = new Personnel.Builder("maryeme", "elmchichi", "ingénieure").build();
    ...
    public void testAnnuaireComplet() {
        ...
        Personnel m1 = new Personnel.Builder("maryeme", "elmchichi", "ingénieure").updatePhoneList(telist).build();
        Personnel m2 = new Personnel.Builder("employer", "capgemini", "dévloppeur").updatePhoneList(telist).build();
